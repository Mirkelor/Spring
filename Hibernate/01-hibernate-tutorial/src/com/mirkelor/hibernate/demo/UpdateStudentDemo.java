...
public class UpdateStudentDemo {
    ...
    public static void main(String[] args){
        ...
        try{
            ...
            myStudent.setFirstName("Stephanie");
            myStudent.setLastName("Buttermore");
            myStudent.setEmail("stephanie.buttermore@gmail.com");
            ...
            session.createQuery("update Student set email = replace(email, 'gmail', 'hotmail')").executeUpdate();
